...
Berikut adalah cara penggunaan *${botName}*
         ────────────────
Kalo gak paham tuh baca dulu tod -_-
         ────────────────
➸ *${prefix}sticker*
Kirim gambar/video dengan caption sticker
➸ *${prefix}ttp*
Text to sticker contoh : ${prefix}ttp XLaw CD
➸ *${prefix}tts*
Suara google contoh : ${prefix}tts id Hallo XLaw
➸ *${prefix}toimg*
Reply sticker yang mau dijadiin image
➸ *${prefix}nulis*
Untuk menulis dibuku
➸ *${prefix}stalkig*
Stalking instagram contoh : ${prefix}stalkig dirgasa1202
➸ *${prefix}quotes*
Random quotes
➸ *${prefix}bikinquote*
Membuat quotes contoh : ${prefix}bikinquote Kamu gay & XLaw
➸ *${prefix}play*
...
➸ *${prefix}pornhub*
Membuat logo, contoh : ${prefix}pornhub XLaw & Hub
